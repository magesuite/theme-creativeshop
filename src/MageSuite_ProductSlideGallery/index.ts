...
const galleryElement: HTMLDivElement = document.querySelector('.cs-slide-gallery');

if (galleryElement) {
    const imageParams: IGalleryImageParams = JSON.parse(galleryElement.dataset.imageParams);
