/**
 * Customer Page entry point (User Area).
 * It imports all the components required by Customer Page.
...
import 'components/component-spacing';
...
import 'components/reset-list-style';
...
// import 'components/hide-scrollbar';
