...
export default class GooglePlaceDetector {
     ...
     * @constructor
     */
    constructor( options: { dev: boolean, apiKey: string, language: string, region: string } ) {
        this.dev = options.dev;
        this.options = options;

        this.baseApiUrl = 'https://maps.googleapis.com/maps/api/place/autocomplete/json';
    ...
    public getFormattedAddress( result: any ): any {
        ...
        for ( const component of components ) {
            result.types[ i ] === 'route' || result.types[ i ] === 'street_address'  ? address.street = component.value : null;
