...
const Player: PlayerAbstract = {
    youtube: {
        ...
        pause: (id: string, userPaused?: boolean) =>
            youtubePlayer.pause(id, userPaused),
    ...
    vimeo: {
        ...
        pause: (id: string, userPaused?: boolean) =>
            vimeoPlayer.pause(id, userPaused),
    ...
    facebook: {
        ...
        pause: (id: string, userPaused?: boolean) =>
            facebookPlayer.pause(id, userPaused),
    ...
    file: {
        ...
        pause: (id: string, userPaused?: boolean) =>
            filePlayer.pause(id, userPaused),
